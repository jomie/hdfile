  ...
  <script type="text/javascript">
  	$(function(){
  		...
  		$("#moveBtn").bind("click", function(){
  			...
  			window.location = "move?dir=" + $("#dir").val() +"&oldName="+$("#oldName").val()+"&newDir="+$("#newDir").val()+"&ifPrivate=0";
  			//alert("move?dir=" + $("#dir").val() +"&oldName="+$("#oldName").val()+"&newDir="+$("#newDir").val());
  		});
  		$("a[name='cancleShareBtn']").bind("click", function(){
  			var filename = $(this).attr("filename");
  			alert(filename); 
  				//return false;
  			console.log("moveBXXBtn click:"+filename);
  			window.location = "share-to-bxx?dir=" + $("#dir").val() +"&oldName="+filename+"&ifPrivate=1";
  		});
  		...
  		$("#renameBtn").bind("click", function(){
  			...
  			$.post("rename", params, function(data){
  				...
  				if(resultObj.status == "success")
  					window.location =  "filelist?dir=" + $("#dir").val();
  				else
  					alert("重命名失败.");
  			});
  			//alert("move?dir=" + $("#dir").val() +"&oldName="+$("#oldName").val()+"&newDir="+$("#newDir").val());
  		...
  		$("#deleteBtn").bind("click", function(){
  			var jump = "delete-share?dir="+"<s:property value='dir'/>"+"&oldName="+$("#deleteName").val();
  					//+ "&fileId="+$("#deleteId").val();
  			//alert(jump);
  			location = jump;
  		});
  		$("#mkdirBtn").bind("click", function(){
  			$.post("mkdir", $("#mkdirForm").serialize(), function(data){
...
<body style="padding:0px;">
  ...
  <div class="" style="margin:70px 0px 0px 0px">
   	<jsp:include page="left_bar_filelist.jsp"></jsp:include>
   ...
   <div class="row-fluid">
     ...
     <div class="span10 offset2"  style="margin-right:50px;padding-right:50px;">
      ...
      <ul class="breadcrumb">
        <li><a href="filelist?dir=/">根目录</a></li>
        ...
        <s:iterator value="folderLevelArr" id="oneFolder">
        	<li><a href="filelist?dir=<s:property value='#tempDirLvl + #oneFolder + \"/\"'/>"><s:property value="#oneFolder"/> </a><span class="divider">/</span></li>
      ...
      <div class="row-fluid" style="margin-bottom:20px;">
	      	<!-- 上传组件 -->
	      	<div class="span4">
			<a href="#ajaxUploadModal" role="button" class="btn btn btn-primary" data-toggle="modal"><img alt="上传" style="margin-right:6px;" src="img/icon_upload_24.png">分享文件</a>
		    ...
		    <div class="pagination span8" style="margin:2px;">
		      <ul>
		        <li>
		        <a reclass="btn" href="filelist?dir=<s:property value='dir'/>&pageNo=<s:property value='lastPageNo'/>">上一页</a>
				</li>
				<li>
				<a reclass="btn" href="filelist?dir=<s:property value='dir'/>&pageNo=<s:property value='nextPageNo'/>">下一页</a>
				</li>
				<li class="disabled">
	...
	<script type="text/javascript">
      ...
      <div id="mkdirModal" class="modal hide fade">
        ...
        <form id="mkdirForm" action="mkdir" method="post">
        <div class="modal-body">
          <!-- <p>One fine body…</p> -->
      ...
      <table class="table table-hover">
       ...
       <s:iterator value="list1" id="m">
    	...
    	<s:iterator value="list2" id="m">
    		...
    		<td id="td-2nd">
    			<s:if test="#d==\"/\"">
	    			<a href="javascript:void(0);" href_foo="filelist?dir=/<s:property value='#m["pathSuffix"]'/>/"><s:property value="#m['pathSuffix']"/></a>
    			</s:if>
    			<s:else>
	    			<a href="javascript:void(0);" href_foo="filelist?dir=<s:property value='#d'/><s:property value='#m["pathSuffix"]'/>/"><s:property value="#m['pathSuffix']"/></a>
    			</s:else>
    		</td>
    		<td>&nbsp;<a><s:property value="#m['length']"/></a></td>
    		<!-- 下载_进入 
    		...
    		<td>
    			<div class="btn-group">
				  ...
				  <ul local_name="toggle_ul" class="dropdown-menu" style="min-width: 90px; margin-top: 0px;/*重要*/">
				    <!-- dropdown menu links -->
				    <li>
				    	<a reclass="btn" href="download?downname=<s:property value='#m["pathSuffix"]'/>&dir=<s:property value='#d'/>">下载</a>
				    </li>
				    <li>
				    ...
				    <li class="divider"></li>
				    <li>
						<a name="cancleShareBtn" href="javascript:void(0);" filename="<s:property value="#m['pathSuffix']"/>" reclass="btn btn-info">取消分享</a>
					</li>
				  </ul>
				</div>
    		</td>
    ...
    <!-- 重命名的modal -->
      <div id="renameModal" class="modal hide fade">
        ...
        <form id="renameForm" action="mkdir" method="post">
        <div class="modal-body">
          <!-- <p>One fine body…</p> -->
