...
<html>
  ...
  <div class="row-fluid" style="margin:70px 0px 0px 0px">
    ...
    <table class="table table-striped">
    	<s:iterator value="pager.resultList" id="oneArr">
    		<tr>
    		  <!-- <td><s:property value="#oneArr[0].fileid"/></td> -->
    		  <td><s:property value="#oneArr[0].filename"/></td>
    		  <td><s:property value='#oneArr[1].downdate'/></td>
    		  <td><a id="" class="btn" href="downOT?pathWithUsername=<s:property value='#oneArr[0].filepath + #oneArr[0].filename'/>" >下载</a></td>
    		</tr>
    	</s:iterator>
    	<tr></tr>
    </table>
