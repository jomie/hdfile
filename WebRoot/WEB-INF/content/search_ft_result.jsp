...
<html>
  <head>
    ...
    <title>标签 - <s:property value='tname'/></title>
    ...
    <table class="table table-striped  table-hover">
    	<s:iterator value="pager.resultList" id="oneResult">
    		<tr>
    		  ...
    		  <td><a name="tips_a" href="#"  redata-toggle="tooltip" redata-placement="top" redata-title="myMethod();"><s:property value="#oneResult.filename"/></a></td>
    		  <td><s:iterator value="#oneResult.fileTags" id="oneTag">
    		  <span class="badge badge-success"><s:property value="#oneTag.tags.tagname"/></span>
    		  </s:iterator></td>
