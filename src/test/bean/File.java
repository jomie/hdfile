...
public class File implements java.io.Serializable {
	...
	/** minimal constructor */
	public File(String filename, Date sharedate, String filepath,
	...
	/** full constructor */
	public File(Cate2 cate2, String filename, Date editionyear, Date sharedate,
			Short grade, String picpath, String intro, String filepath,
			Short isPrivate, Short isPrivateOrigin, Set fileTags,
			Set favorUserFiles, Set grades, Set downloads, Set uploads,
			Set comments) {
		this.cate2 = cate2;
		this.filename = filename;
